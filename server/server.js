...
app.get('*', async (req, res, next) => {
    ...
    const html = `
        ...
        <head>
            ...
            <title>風滿樓</title>
            <link rel="preload shortcut icon" href="/favicon.ico"/>
            ...
            <link rel="preload" as="font" href="https://www.fluttering.cn/uploads/lixuke.css">
            <link rel="preload"  href="${manifestPath['static/media/Home.less']}">
            <link rel="preload"  href="${manifestPath['static/media/lotus.png']}">
            </head>
        <body>
            <div id="root">
   `
    ...
    ReactSSR.on('end', function () {
        res.write(`
                ...
                <link rel="preload" href=${manifestPath["static/js/1.37e8ee76.chunk.js"]}/>
                <link rel="preload" href=${manifestPath["main.js"]}/>
            </body>
        </html>`)
        res.end()
    })
